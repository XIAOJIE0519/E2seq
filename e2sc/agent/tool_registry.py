...
class ToolRegistry:
    ...
    def _register_all_tools(self) -> None:
        ...
        # 12. BioGRID - 实验验证的蛋白互作、遗传互作、化学互作
        self.register_tool(
            name="query_biogrid_interactions",
            func=lambda genes, max_results=100: self.api_clients["biogrid"].get_interactions(
                genes if isinstance(genes, list) else [genes], max_results),
            description="查询BioGRID获取实验验证的蛋白互作网络（包含实验系统、PMID）。输入：基因列表",
            parameters={
                "type": "object",
                "properties": {
                    "genes": {"type": "array", "items": {"type": "string"}, "description": "基因名称列表"},
                    "max_results": {"type": "integer", "description": "最大返回结果数", "default": 100}
                },
                "required": ["genes"]
            }
        )
        ...
        self.register_tool(
            ...
            func=lambda gene, max_results=50: self.api_clients["gtex"].get_gene_expression(gene, max_results),
        ...
        self.register_tool(
            name="query_humanbase_expression",
            func=lambda gene, max_results=50: self.api_clients["humanbase"].get_gene_expression(gene, max_results),
        ...
        self.register_tool(
            name="query_humanbase_tissue_network",
            func=lambda gene, tissue="brain": self.api_clients["humanbase"].get_tissue_network(gene, tissue),
        ...
        self.register_tool(
            ...
            func=lambda query: self.api_clients["alliance"].search_cross_species(query),
        ...
        self.register_tool(
            ...
            func=lambda gene, species="human": self.api_clients["alliance"].get_homologs(gene, species),
