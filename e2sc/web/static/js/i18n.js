...
const i18n = {
    'zh-CN': {
        ...
        'chat.subGreeting': '需要我根据上传的 bulk / 单细胞基因数值进行 RAG 解读吗？',
        'chat.inputPlaceholder': '输入你的问题，例如：解读Enterocytes中的输入基因数值...',
        'chat.send': '发送',
        'chat.attach': '添加附件',
        'chat.tools': '工具',
        'chat.charts': '可视化图表',
        'chat.hint': 'E2seq 可能会出错，请核实重要信息',
        'chat.placeholder': '输入你的问题，例如：解读输入基因数值与检索证据...',
        'chat.uploadFile': '上传文件',
        'chat.pleaseSelectFile': '点击选择文件',

        // 建议提示词
        'suggestion.deg': '根据上传数值解读所选基因',
        'suggestion.enrichment': '检索通路与 GO 外部注释（Reactome + QuickGO）',
        'suggestion.network': '检索已知互作与调控证据（STRING + TRRUST）',
        'suggestion.hub': '解读药物靶点与疾病证据（ChEMBL + Open Targets）',
        'suggestion.umap': '解读代谢物与肠道菌群注释（HMDB + GUTMGENE）',
        ...
        'upload.singlecellDesc': '读取已有表达矩阵、细胞类型和分组标签用于 RAG 解读',
        'upload.tableTitle': '表格数据',
        'upload.tableFormats': '支持 .csv / .tsv / .xlsx 格式',
        'upload.tableDesc': '用于已有基因结果、表达数值与分组标签的 RAG 解读',
    ...
    'en-US': {
        ...
        'chat.subGreeting': 'Interpret uploaded bulk or single-cell gene values with RAG evidence.',
        'chat.inputPlaceholder': 'Enter your question, e.g.: Interpret uploaded gene values...',
        'chat.send': 'Send',
        'chat.attach': 'Attach',
        'chat.tools': 'Tools',
        'chat.charts': 'Charts',
        'chat.hint': 'E2seq may make mistakes. Please verify important information.',
        'chat.placeholder': 'Ask how to interpret the uploaded gene values...',
        'chat.uploadFile': 'Upload File',
        'chat.pleaseSelectFile': 'Click to Select File',

        // Suggestion chips
        'suggestion.deg': 'Interpret uploaded gene values',
        'suggestion.enrichment': 'Retrieve pathway and GO annotations',
        'suggestion.network': 'Retrieve known interaction evidence',
        'suggestion.hub': 'Interpret drug-target and disease evidence',
        'suggestion.umap': 'Interpret metabolite and microbiome annotations',
        ...
        'upload.singlecellDesc': 'Read existing expression values, cell types, and group labels for RAG interpretation.',
